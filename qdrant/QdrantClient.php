...
class QdrantClient
{
	...
	public function createCollection($collectionName, $vectorSize)
	{
		...
		return $this->request("/collections/$collectionName", "PUT", $data);
	}
	...
	{
		return $this->request("/collections/$collectionName", "DELETE");
	}
	...
	public function deletePoints(string $collection, array $pointIds)
	{
		$data = [
			'points' => $pointIds
		];

		return $this->request("/collections/$collection/points/delete", 'POST', $data);
	}
}
