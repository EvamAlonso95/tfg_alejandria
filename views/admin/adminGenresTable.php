        ...
        $('#myTable').on('click', '.btn-delete', function(e) {
            ...
            if (confirm("¿Estás seguro de que deseas eliminar este género?")) {
                $.ajax({
                    ...
                    error: function() {
                        showToast('Error al eliminar el género.', false);
                    }
                });
            }
        });
            ...
            $.ajax({
                ...
                success: function(response) {
                    try {
                        ...
                        if (res.error) {
                            showToast(res.error, false); // Mostrar error con fondo rojo
                        } else {
                            $('#modalGenre').modal('hide');
                            $('#myTable').DataTable().ajax.reload();
                            showToast(res.success || '¡Género guardado correctamente!');
                        }
                    } catch (e) {
                ...
                error: function() {
                    showToast('Error al guardar el género.', false); // Mostrar error con fondo rojo
                }
            });
